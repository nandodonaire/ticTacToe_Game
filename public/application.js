...
var onSearchGames = function onSearchGames(event) {
  var data = getFormFields(this);
  // console.log('events', data)
  event.preventDefault();
  gameApi.searchGames(data).then(gameUi.searchGamesSuccess).catch(gameUi.searchGamesFailure);
};

var onSearchGame = function onSearchGame(event) {
  var data = getFormFields(this);
  // console.log('events', data)
  event.preventDefault();
  gameApi.searchGame(data).then(gameUi.searchGameSuccess).catch(gameUi.searchGameFailure);
...
var searchGames = function searchGames(data) {
  return $.ajax({
...
var searchGame = function searchGame(data) {
  return $.ajax({
...
var searchGamesSuccess = function searchGamesSuccess(data) {
  // console.log(data)
...
var searchGamesFailure = function searchGamesFailure(data) {
  // console.error(error)
  $('#jumbotron-message').text('Unable to search games!');
  $('#jumbotron-message').css('color', 'red');
};

var searchGameSuccess = function searchGameSuccess(data) {
  // console.log(data)
...
var searchGameFailure = function searchGameFailure(data) {
  // console.error(error)
...
module.exports = {
  searchGamesSuccess: searchGamesSuccess,
  searchGamesFailure: searchGamesFailure,
  searchGameSuccess: searchGameSuccess,
  searchGameFailure: searchGameFailure,
